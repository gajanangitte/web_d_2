...
var School = function () {
  ...
  _createClass(School, [{
    ...
    set: function set(num) {
      if (typeOf(num) === 'number') this._numberOfStudents = num;else console.log('Invalid input: numberOfStudents must be set to a Number.');
    }
  }], [{
    key: 'pickSubstituteTeacher',
    value: function pickSubstituteTeacher(substituteTeachers) {
      var index = Math.floor(Math.random() * substituteTeachers.length);
